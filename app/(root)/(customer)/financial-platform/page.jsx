        ...
        <div className="col-span-12 md:col-span-10">
          <div className="grid grid-cols-12 gap-4 mt-10">
            <div className="col-span-12 md:col-span-4">
              ...
              <div className="bg-blue-500 px-3 py-4 flex mt-8 justify-between text-white items-center">
                <h2 className="text-lg">Tags Issued.</h2>
                <h2 className="text-lg">300</h2>
              </div>
              <div className="bg-blue-500 px-3 py-4 flex mt-4 justify-between text-white items-center">
